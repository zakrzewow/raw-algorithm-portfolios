#!/bin/bash
#SBATCH --job-name=run-plain-500-scaling
...
srun /home2/faculty/gzakrzewski/miniconda3/envs/SMAC/bin/python /home2/faculty/gzakrzewski/raw-algorithm-portfolios/py_plain_500_scaling.py
